...
part of 'auth_module_api_client.dart';
...
class _AuthModuleApiClient implements AuthModuleApiClient {
  _AuthModuleApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<dynamic> loginDriver(String email, String password) async {
  ...
  @override
  Future<VehicleResponseModel> getVehicles() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<VehicleResponseModel>(
    ...
    try {
      _value = VehicleResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
